...
const translations = {
    en: {
        ...
        'order.detail.fulfillment': 'Fulfillment',
        'shipment.none': 'No shipment yet.',
    ...
    km: {
        ...
        'order.detail.fulfillment': 'ការដឹកជញ្ជូន',
        'shipment.none': 'មិនទាន់មានការដឹកជញ្ជូនទេ។',
        'shipment.status': 'ស្ថានភាព',
